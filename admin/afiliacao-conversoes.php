...
$summary = conversion_report_summary($startDate, $endDate);
$rows = conversion_report_rows($startDate, $endDate);
?>
<?php admin_layout_start('Conversoes de afiliacao - Oferto Cupons', 'afiliacao', 'Afiliacao'); ?>
      <section class="admin-hero">
        <div>
          <p class="section-kicker">Conversoes</p>
          <h1>Resultado financeiro das redes</h1>
          <p>Esta leitura separa vendas, leads e comissoes recebidas das integracoes de afiliacao.</p>
        </div>
      ...
      <section class="admin-kpi-grid">
        ...
        <article class="admin-kpi-card">
          ...
          <small>Comissao bruta recebida</small>
        </article>
        <article class="admin-kpi-card">
          <span>Aprovada</span>
        ...
        <div class="admin-table-wrap">
          <table class="admin-table admin-report-table">
            ...
            <tbody>
              ...
              <?php endforeach; ?>
              <?php if (!$rows): ?>
                <tr><td colspan="7" class="admin-empty-cell">Nenhuma conversao sincronizada neste periodo.</td></tr>
              <?php endif; ?>
            </tbody>
          </table>
        </div>
