...
<?php admin_layout_start('APIs - Oferto Cupons', 'apis', 'Integracoes'); ?>
      <section class="admin-hero admin-api-hero">
        <div>
          ...
          <h1>Escolha o que entra no Oferto</h1>
          <p>Conecte redes de afiliados, filtre marcas boas e publique so as ofertas que fazem sentido para a vitrine.</p>
        </div>
        <div class="admin-hero-stats" aria-label="Resumo das integracoes">
          <span><strong>1</strong> parceiro ativo</span>
          <span><strong>4</strong> tipos de fonte</span>
        </div>
      </section>
